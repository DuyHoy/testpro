             ...
             <div class="container">
                <div class="row">
                   <div class="col-md-6">
                      ...
                      <div class="lead">We are a top-tier manufacturing partner with over 25 years of experience.</div>
                   </div>
                </div>
             </div>
          </div>
       ...
       <section class="page-body-block">
          <div class="wp-block-magicblock-magicblock container py-6">
             ...
             <div class="wp-block-magicblock-magicblock row mt-5">
                ...
                <div class="wp-block-magicblock-magicblock col-md-4 col-12">
                   <p><strong>TJ Aerospace promises products of uncompromised quality, delivered on-time and at a competitive price. </strong></p>
                </div>
             </div>
             <div class="wp-block-magicblock-magicblock row mt-5">
                <div class="wp-block-magicblock-magicblock col-lg-6 col-md-5 col-12">
                   <h5 class="text-uppercase text-primary font-weight-semibold">Quality</h5>
                   <h2 class="text-uppercase">Our Policy</h2>
                   <p>To provide products and services that will meet and exceed our customer’s expectations and continually improve TJ Aerospace’s quality management system.  </p>
                </div>
          ...
          <div class="wp-block-media-text alignwide">
             ...
             <div class="wp-block-media-text__content">
                ...
                <p><strong>TJ Aerospace management is committed to the safety of the company’s operations and in particular, to the health and safety of employees, customers and the public in general.</strong></p>
             </div>
          </div>
          <section id="keyfactsblock-block_5d1c7573d5862" class="keyfactsblock bg-primary">
             <div class="inner">
                <h6 class="mb-3 mb-sm-5 mx-auto text-center text-uppercase text-light font-weight-bold">Key Facts</h6>
                <div class="container">
                   <div class="row">
                      <div class="col-md-3 col-6 text-center mx-auto">
                         <div class="counter-item"><span class="counter-up">94</span>%</div>
                         <h6>Overall Equipment Effectiveness</h6>
                      </div>
                      <div class="col-md-3 col-6 text-center mx-auto">
                         <div class="counter-item"><span class="counter-up">97</span>%</div>
                         <h6>Overall Operating Efficiency</h6>
                      </div>
                      <div class="col-md-3 col-6 text-center mx-auto">
                         <div class="counter-item"><span class="counter-up">7</span>%</div>
                         <h6>Machine Downtime</h6>
                      </div>
                      <div class="col-md-3 col-6 text-center mx-auto">
                         <div class="counter-item"><span class="counter-up">5</span>%</div>
                         <h6>Unscheduled Downtime</h6>
                      </div>
                   </div>
                </div>
             </div>
          ...
          <div class="wp-block-media-text alignwide has-media-on-the-right">
             ...
             <div class="wp-block-media-text__content">
                <h5 class="text-uppercase text-primary font-weight-semibold">Benefits</h5>
                <h2 class="mb-4">Core Capabilities</h2>
                <ul class="list">
                   <li>CNC Milling &amp; Turning of Various Materials</li>
                   <li>Prototype to High Volume Manufacturing</li>
                   <li>Lean, Automated Manufacturing</li>
                   <li>Lights-Out Manufacturing</li>
                   <li>Smart Manufacturing</li>
                   <li>In-House Fixturing &amp; Tooling</li>
                   <li>Additive Manufacturing</li>
                   <li>Long-Term Contract Manufacturing</li>
                   <li>Sheet Metal Fabrication</li>
                   <li>Assembly/Sub-Assembly/Kitting</li>
                   <li>Engineering</li>
                   <li>CAM Programming Services</li>
                   <li>Ultrasonic Multi-Stage Cleaning</li>
